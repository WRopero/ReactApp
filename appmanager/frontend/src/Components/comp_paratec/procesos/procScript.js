...
import Subproceso_1 from './act_Script/subScript_1';
import Subproceso_2 from './act_Script/subScript_2';
import Subproceso_3 from './act_Script/subScript_3';
import Subproceso_4 from './act_Script/subScript_4';
import Subproceso_5 from './act_Script/subScript_5';



export class procScript extends Component {
    render() {
        return (
            <div style={{marginTop:"1rem"}}>
                <p className="h3 pt-2">Modificación de Elementos en Base de Datos Vía Script</p>
                            ...
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="0" style={{textDecoration:"none"}}>
                                    <p className="m-0 p-0 h5" style={{color:"#2F4F4F"}}>
                                        1.	Identificar elementos a modificar.
                                    </p>
                                </Accordion.Toggle>
                            </Card.Header>
                        ...
                        <Card>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="2" style={{textDecoration:"none"}}>
                                    <p className="m-0 p-0 h5" style={{color:"#2F4F4F"}}>
                                        3.	Solicitar ejecución de script via portal TI (MVM).
                                    </p>
                                </Accordion.Toggle>
                            </Card.Header>
                        ...
                        <Card>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="3" style={{textDecoration:"none"}}>
                                    <p className="m-0 p-0 h5" style={{color:"#2F4F4F"}}>
                                        4.	Validar actualización en base de datos.
                                    </p>
                                </Accordion.Toggle>
                            </Card.Header>
                        ...
                        <Card>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="5" style={{textDecoration:"none"}}>
                                    <p className="m-0 p-0 h5" style={{color:"#2F4F4F"}}>
                                        5.	Autorizar cierre del requerimiento.
                                    </p>
                                </Accordion.Toggle>
                            </Card.Header>
