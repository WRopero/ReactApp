...
import Subproceso_1 from './act_con_mintec_curva/subControl_1';
import Subproceso_2 from './act_con_mintec_curva/subControl_2';
import Subproceso_3 from './act_con_mintec_curva/subControl_3';
import Subproceso_4 from './act_con_mintec_curva/subControl_4';
import Subproceso_5 from './act_con_mintec_curva/subControl_5';
import Subproceso_6 from './act_con_mintec_curva/subControl_6';
import Subproceso_7 from './act_con_mintec_curva/subControl_7';
import Subproceso_8 from './act_con_mintec_curva/subControl_8';
import Subproceso_9 from './act_con_mintec_curva/subControl_9';
import Subproceso_10 from './act_con_mintec_curva/subControl_10';
import Subproceso_11 from './act_con_mintec_curva/subControl_11';
import Subproceso_12 from './act_con_mintec_curva/subControl_12';
import Subproceso_13 from './act_con_mintec_curva/subControl_13';
import Subproceso_14 from './act_con_mintec_curva/subControl_14';


export class proControl_mint extends Component {
    render() {
        return (
            <div style={{marginTop:"1rem"}}>
                <p className="h3 pt-2">Actualización de Parámetros de Control, Mínimo Técnico ó Curva de Carga de Recursos de Generación</p>
                        ...
                        <Card>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="2" style={{textDecoration:"none"}}>
                                    <p className="m-0 p-0 h5" style={{color:"#2F4F4F"}}>
                                        3.	Dividir requerimiento en CRM con el equipo de @CONTROLES.
                                    </p>
                                </Accordion.Toggle>
                            </Card.Header>
                        ...
                        <Card>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="3" style={{textDecoration:"none"}}>
                                    <p className="m-0 p-0 h5" style={{color:"#2F4F4F"}}>
                                        4.	Concepto emitido por @CONTROLES.
                                    </p>
                                </Accordion.Toggle>
                            </Card.Header>
                        ...
                        <Card>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="8" style={{textDecoration:"none"}}>
                                    <p className="m-0 p-0 h5" style={{color:"#2F4F4F"}}>
                                        8.	Remitir la solicitud y el concepto CND a subcomité de controles.
                                    </p>
                                </Accordion.Toggle>
                            </Card.Header>
...
export default proControl_mint
