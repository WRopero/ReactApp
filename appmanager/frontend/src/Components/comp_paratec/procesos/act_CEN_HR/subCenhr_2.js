...
export class subCenhr_2 extends Component {
    render() {
        return (
            <div>
                ...
                El objetivo de el análisis exploratorio es identificar inconsistencias en los datos
                    ...
                    <br></br><br></br>
                    <ul>
                        <li>Para <i>Capacidad Efectiva Neta (CEN)</i> verificar los anexos y la solicitud clara. La justificación
                        clara sobre el cambio.</li>
                        <li>Para <i>Heat Rate</i> verificar que el valor solicitado sea igual al de la prueba anexada.
