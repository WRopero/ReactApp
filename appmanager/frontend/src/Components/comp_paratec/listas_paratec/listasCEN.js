...
export class listasCEN extends Component {
                ...
                <Table hover>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color3 ? "#40e330": ""}}>Solicitar concepto al equipo de @DESPACHO.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color4 ? "#40e330": ""}}>Concepto emitido por @DESPACHO.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color8 ? "#40e330": ""}}>Remitir la solicitud y el concepto CND a subcomité de Plantas.</td>
