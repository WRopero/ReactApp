...
export class listasCertificado extends Component {
                ...
                <Table hover>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color2 ? "#40e330": ""}}>Elaborar carta de respuesta e informe.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color3 ? "#40e330": ""}}>Solicitar revisión interna del informe y de la carta redactada.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color4 ? "#40e330": ""}}>Enviar carta y informe al agente.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color5 ? "#40e330": ""}}>Finalizar requerimiento en CRM.</td>
...
export default listasCertificado
