...
export class listasRegFrontera extends Component {
                ...
                <Table hover>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style={{background: this.state.color1 ? "#40e330": ""}}>Recepción de parámetros técnicos preliminares.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color2 ? "#40e330": ""}}>Creación del recurso de generación en base de datos.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color4 ? "#40e330": ""}}>Ingresar elementos en colecciones.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color5 ? "#40e330": ""}}>Actualización código bdmem.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color6 ? "#40e330": ""}}>Registro en la tabla BASICAS.T85SMGEMOCA.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color7 ? "#40e330": ""}}>Registro en la tabla BASICAS.RAT_SBMMAPEO.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color8 ? "#40e330": ""}}>Validación registro de frontera comercial.</td>
...
export default listasRegFrontera
