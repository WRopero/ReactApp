...
export class listasControl extends Component {
                ...
                <Table hover>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color3 ? "#40e330": ""}}> Dividir requerimiento en CRM con el equipo de @CONTROLES.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color4 ? "#40e330": ""}}>Concepto emitido por @CONTROLES.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color8 ? "#40e330": ""}}>Remitir la solicitud y el concepto CND a subcomité de controles.</td>
