...
export class listasTransmi extends Component {
                ...
                <Table hover>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color3 ? "#40e330": ""}}>Verificación de parámetros a modificar.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color4 ? "#40e330": ""}}>Solicitar concepto al equipo de análisis eléctrico y al equipo de eventos & protecciones.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color5 ? "#40e330": ""}}>Concepto emitido por @EVENTOS Y PROTECCIONES y por @Análisis Eléctrico.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color6 ? "#40e330": ""}}>Realizar actualización de parámetros en base de datos.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color7 ? "#40e330": ""}}>Generar y enviar correo informativo sobre la actualización realizada.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color8 ? "#40e330": ""}}>Informar al agente.</td>
                        ...
                        <tr>
                            ...
                            <td style={{background: this.state.color9 ? "#40e330": ""}}>Publicar noticia en PARATEC.</td>
